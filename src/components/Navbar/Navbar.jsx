    ...
    >
      <div className="flex items-center justify-between py-5 text-white">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Sandun</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Chathuranga</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden space-x-4 md:flex">
          <a
            href="https://github.com/BSChathuranga"
            target="_blank"
          ...
          <a
            href="http://www.linkedin.com/in/chathuranga"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >

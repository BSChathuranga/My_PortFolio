...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_j5vfclp",  // Replace with your EmailJS Service ID
        "template_xyeh46b",  // Replace with your EmailJS Template ID
        form.current,
        "uHDBSgsqTzwjBogFr"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
